                        ...
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="password" class="form-control" id="passwprd" value="">
                                </div>
                               <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    <label for="city">Building<span>*</span></label>
                                    <input type="text" class="form-control" id="building" value="">
                                </div>
                                <div class="col-12 mb-3">
                                    <button class="btn essence-btn" type="submit" name="submit">Register</button>
                                </div>
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="checkout_details_area mt-50 clearfix">
                       ...
                       <label for="company">Password</label>
                        ...
                        <a href="#" class="btn essence-btn">Sign In</a>
                </div>
            </form>
            </div>
        </div>
